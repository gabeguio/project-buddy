package com.nashss.se.projectmanagementservice.metrics;
...
public class MetricsConstants {
    ...
    public static final String SERVICE_NAME = "projectmanagementservice";
    public static final String NAMESPACE_NAME = "U3/projectmanagementservice";
}
